...
pub const OPL_EMU_REGISTERS_OPERATORS: usize = OPL_EMU_REGISTERS_CHANNELS * 2;

pub const OPL_EMU_REGISTERS_STATUS_BUSY: u8 = 0;

pub const OPL_EMU_REGISTERS_WAVEFORMS: usize = 8;

pub const OPL_EMU_REGISTERS_CHANNELS: usize = 18;
...
fn opl_emu_registers_byte(regs: &OplEmuRegisters, offset: u32) -> u32 {
    opl_emu_bitfield(regs.m_regdata[offset as usize] as u32, 0, 8)
}
...
fn opl_emu_set_reset_status(emu: &mut OplEmu, set: u8, reset: u8) -> u8 {
    ...
    //emu.m_intf.opl_emu_sync_check_interrupts();
