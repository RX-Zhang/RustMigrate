...
fn aptx_quantized_parity(channel: &AptxChannel) -> u32 {
    let mut parity: u32 = channel.dither_parity as u32;

    for subband in 0..NB_SUBBANDS {
        parity ^= channel.quantize[subband].quantized_sample as u32;
    }
...
fn aptxhd_pack_codeword(channel: &AptxChannel) -> u32 {
   ...
   (((channel.quantize[3].quantized_sample as u32 & 0x01E) | parity) << 19)
       | (((channel.quantize[2].quantized_sample as u32 & 0x00F) as u32) << 15)
       | (((channel.quantize[1].quantized_sample as u32 & 0x03F) as u32) << 9)
       | (((channel.quantize[0].quantized_sample as u32 & 0x1FF) as u32))
}
