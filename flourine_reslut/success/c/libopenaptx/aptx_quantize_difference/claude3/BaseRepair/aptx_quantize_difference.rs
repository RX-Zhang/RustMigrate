...
fn rshift64(value: i64, shift: u32) -> i64 {
    ...
    ((value.wrapping_add(rounding as i64)) >> shift)
        - ((value & mask) == (rounding as i64)) as i64
}
...
fn aptx_quantize_difference(
    ...
    let interval = (intervals[1] - intervals[0]) * ((sample_difference >= 0) as i32 * 2 - 1);
    ...
    let inv = (sample_difference >= 0) as i32 * 2 - 1;
