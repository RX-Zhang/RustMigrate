...
struct OplEmuOpdataCache {
    ...
    eg_rate: [u8; OPL_EMU_EG_STATES as usize],       // envelope rate, including KSR
...
struct OplEmuFmOperator {
    ...
    m_cache: OplEmuOpdataCache,                  // cached values for performance
    m_regs: *mut OplEmuRegisters,                  // direct reference to registers
}
...
fn opl_emu_fm_channel_assign(
    ...
    if let Some(ref mut op) = fmch.m_op[index as usize] {
        opl_emu_fm_operator_set_choffs(op.as_mut(), fmch.m_choffs);
    }
}
