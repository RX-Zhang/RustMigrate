...
fn opl_emu_bitfield(value: u32, start: i32, length: i32) -> u32 {
    ((value >> start.wrapping_sub(0)) & ((1 << length) - 1)) as u32
}

fn opl_emu_registers_byte(regs: &OplEmuRegisters, offset: u32, value: u32, start: u32, count: u32) -> u32 {
    opl_emu_bitfield(value, start.wrapping_sub(0) as i32, count as i32)
}

fn opl_emu_registers_status_mask(regs: &OplEmuRegisters) -> u8 {
    (opl_emu_registers_byte(regs, 0x04, regs.m_regdata[0x04 as usize] as u32, 0, 8)).try_into().unwrap()
}
