...
struct OplEmu {
    ...
    m_channel: [Box<OplEmuFmChannel>; OPL_EMU_REGISTERS_CHANNELS as usize],
    m_operator: [Box<OplEmuFmOperator>; OPL_EMU_REGISTERS_OPERATORS as usize],
}
...
impl OplEmu {
    ...
    fn opl_emu_registers_status_mask(&self) -> u32 {
        self.opl_emu_registers_byte(4, 0, 8, 0) & 0x78
    }
    ...
    fn opl_emu_set_reset_status(
        ...
        self.m_status = (self.m_status | set) & (!reset | OPL_EMU_REGISTERS_STATUS_BUSY as u8);
        ((self.m_status as u32) & !self.opl_emu_registers_status_mask()) as u8
    }
}
