...
fn main() {
    // Example usage can be placed here. The actual test cases as described cannot be directly replicated in Rust main function due to the nature of the input/output structure.
}
