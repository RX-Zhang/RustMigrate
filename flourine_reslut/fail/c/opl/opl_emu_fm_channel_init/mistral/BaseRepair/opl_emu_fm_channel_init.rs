    ...
    fn init(&mut self, choffs: u32) {
        ...
        self.m_op[0] = Box::new(OplEmuFmOperator {
            ...
            m_cache: OplEmuOpdataCache {
                ...
                multiple: 0,
                eg_sustain: 0,
                eg_rate: [0; OplEmuEnvelopeState::OPL_EMU_EG_STATES as usize],
                eg_shift: 0,
            },
        });
        ...
        self.m_regs = Box::new(OplEmuRegisters {
            m_lfo_am_counter: 0,
            m_lfo_pm_counter: 0,
            m_noise_lfsr: 0,
            m_lfo_am: 0,
            m_regdata: [0; OPL_EMU_REGISTERS_REGISTERS as usize],
            m_waveform: [[0; OPL_EMU_REGISTERS_WAVEFORM_LENGTH as usize]; OPL_EMU_REGISTERS_WAVEFORMS as usize],
        });
    }
}
