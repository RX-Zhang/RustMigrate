...
pub struct OplEmuRegisters {
    ...
    pub m_regdata: Box<[u8; 256]>,         // register data
    pub m_waveform: Box<[[u16; 256]; 4]>, // waveforms
}
...
pub fn opl_emu_registers_op_release_rate(regs: &mut OplEmuRegisters, opoffs: u32) -> u32 {
