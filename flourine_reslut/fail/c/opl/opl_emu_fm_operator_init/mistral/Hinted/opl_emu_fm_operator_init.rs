...
struct OplEmuFmOperator {
    ...
    m_key_state: u8,
    m_keyon_live: u8,
    m_regs: *const OplEmuRegisters,
    m_cache: Box<OplEmuOpdataCache>,
}

impl OplEmuFmOperator {
    fn new(regs: &OplEmuRegisters, opoffs: u32) -> Self {
        let cache = Box::new(OplEmuOpdataCache {
            phase_step: 0,
            total_level: 0,
            block_freq: 0,
            detune: 0,
        ...
        OplEmuFmOperator {
            ...
            m_env_state: OplEmuEnvelopeState::OPL_EMU_EG_RELEASE,
            m_key_state: 0,
            m_keyon_live: 0,
            m_regs: regs,
            m_cache: cache,
