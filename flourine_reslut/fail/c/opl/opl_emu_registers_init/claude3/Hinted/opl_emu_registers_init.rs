...
fn opl_emu_registers_init(regs: &mut OplEmuRegisters) {
    ...
    let mut wf0 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    let mut wf1 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    let mut wf2 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    let mut wf3 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    let mut wf4 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    let mut wf5 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    let mut wf6 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    let mut wf7 = [0u16; OPL_EMU_REGISTERS_WAVEFORM_LENGTH];
    ...
    regs.m_waveform = Box::new([
        wf0, wf1, wf2, wf3, wf4, wf5, wf6, wf7,
    ]);
    regs.m_regdata = Box::new([0u8; OPL_EMU_REGISTERS_REGISTERS]);
}
