...
fn opl_loadbank_internal<T>(opl: &mut Opl<T>, file: &str, offset: i32) -> i32 {
    ...
    for i in offset..(offset + 128) {
        ...
        let mut timbre = Box::new(OplTimbre {
            modulator_E862: 0,
            carrier_E862: 0,
            modulator_40: 0,
            carrier_40: 0,
        ...
        timbre.modulator_E862 <<= 8;
        timbre.modulator_E862 |= buff[4] as u32; 
        timbre.modulator_E862 <<= 8;
        ...
        timbre.carrier_E862 <<= 8;
        timbre.carrier_E862 |= buff[5] as u32;
        timbre.carrier_E862 <<= 8;
        timbre.carrier_E862 |= buff[1] as u32;
        ...
        if offset == 0 {
            ...
            opl.opl_gmtimbres_voice2[i as usize] = timbre;
        }
    }
