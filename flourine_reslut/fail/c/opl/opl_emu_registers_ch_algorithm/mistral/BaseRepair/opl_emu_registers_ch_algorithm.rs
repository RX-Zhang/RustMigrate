...
fn opl_emu_registers_byte(regs: &mut OplEmuRegisters, offset: usize, start: usize, count: usize, extra_offset: usize) -> u32 {
    opl_emu_bitfield(u32::from_le_bytes(regs.m_regdata[offset + extra_offset..offset + extra_offset + 1].try_into().unwrap()), start, count)
}

fn opl_emu_registers_ch_algorithm(regs: &mut OplEmuRegisters, choffs: usize) -> u32 {
