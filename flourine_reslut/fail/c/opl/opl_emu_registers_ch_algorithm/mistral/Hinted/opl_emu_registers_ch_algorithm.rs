...
struct OplEmuRegisters {
    ...
    m_waveform: [[u8; OPL_EMU_REGISTERS_WAVEFORM_LENGTH]; OPL_EMU_REGISTERS_WAVEFORMS],
}
...
impl OplEmuRegisters {
    ...
    fn opl_emu_registers_ch_algorithm(&self, choffs: u32) -> u32 {
        self.opl_emu_registers_byte(0xc0, 0, 1, choffs)
            | ((8 | (self.opl_emu_registers_byte(0xc3, 0, 1, choffs) << 1)) as u32)
    }
}
