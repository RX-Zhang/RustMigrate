...
fn opl_emu_bitfield(value: u32, start: i32, length: i32) -> u32 {
    ...
    let mask = Wrapping(((1u32 << length) - 1) << start);
    let shift = start as u32;
    let shifted_value = value.0.wrapping_shr(shift);
    shifted_value & mask.0
}
...
fn opl_emu_attenuation_increment(rate: u32, index: u32) -> u32 {
    ...
    opl_emu_bitfield(S_INCREMENT_TABLE[rate as usize], (index * 4) as i32, 4)
}
