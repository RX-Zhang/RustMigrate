...
impl AptxContext {
    fn new(hd: u8) -> Self {
        AptxContext {
            ...
            decode_dropped: 0,
            channels: std::array::from_fn(|_| AptxChannel::new()),
            hd,
            sync_idx: 0,
            encode_remaining: 0,
...
impl AptxChannel {
    fn new() -> Self {
        AptxChannel {
            ...
            quantize: std::array::from_fn(|_| AptxQuantize::new()),
            invert_quantize: std::array::from_fn(|_| AptxInvertQuantize::new()),
            prediction: std::array::from_fn(|_| AptxPrediction::new()),
        }
    }
}
...
impl AptxQMFAnalysis {
    fn new() -> Self {
        AptxQMFAnalysis {
            outer_filter_signal: std::array::from_fn(|_| AptxFilterSignal::new()),
            inner_filter_signal: std::array::from_fn(|_| std::array::from_fn(|_| AptxFilterSignal::new())),
        }
    }
}
