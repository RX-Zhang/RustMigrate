...
fn aptx_quantized_parity(channel: &AptxChannel) -> i32 {
    ...
    for subband in 0..NB_SUBBANDS {
        parity ^= channel.quantize[subband].quantized_sample as i32;
    }
...
fn aptx_pack_codeword(channel: &AptxChannel) -> u16 {
    ...
    ((channel.quantize[3].quantized_sample & 0x06) as u16).wrapping_shl(13)
        | ((channel.quantize[2].quantized_sample as u16 & 0x03).wrapping_shl(11))
        | ((channel.quantize[1].quantized_sample as u16 & 0x0F).wrapping_shl(7)) 
        | (channel.quantize[0].quantized_sample as u16 & 0x7F)
}
