...
fn aptx_pack_codeword(channel: &AptxChannel) -> u16 {
    ...
    ((channel.quantize[3].quantized_sample & 0x06) as u16 | (parity as u16)).wrapping_shl(13)
        | ((channel.quantize[2].quantized_sample & 0x03) as u16).wrapping_shl(11)
        | ((channel.quantize[1].quantized_sample & 0x0F) as u16).wrapping_shl(7)
