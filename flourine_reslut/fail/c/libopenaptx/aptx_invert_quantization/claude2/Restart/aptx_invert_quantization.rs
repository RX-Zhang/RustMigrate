...
fn aptx_invert_quantization(
    ...
    factor_select = rshift32(
        factor_select.wrapping_add((tables.quantize_factor_select_offset[idx as usize] * (1 << 15)) as i32),
        15,
    );
    invert_quantize.factor_select = 
        clip(factor_select, 0, tables.factor_max);
