...
pub struct aptx_channel {
    ...
    pub quantize: [aptx_quantize; 12],
    pub invert_quantize: [aptx_invert_quantize; 12],
    pub prediction: [aptx_prediction; 12],
}
...
pub fn aptx_reset(ctx: &mut aptx_context) {
    ...
    ctx.hd = hd;
    ctx.decode_skip_leading = 12;
    ctx.encode_remaining = 12;
