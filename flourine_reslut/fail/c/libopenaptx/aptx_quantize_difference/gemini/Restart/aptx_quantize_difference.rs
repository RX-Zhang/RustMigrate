...
fn rshift64(value: i64, shift: u32) -> i64 {
    ...
    ((value + rounding) >> shift) - ((value & mask) != 0) as i64
}
...
fn rshift32(value: i32, shift: u32) -> i32 {
    ...
    ((value + rounding) >> shift) - ((value & mask) != 0) as i32
}
...
fn aptx_quantize_difference(
    ...
    let d = rshift64(d as i64 * tables.quantize_dither_factors[quantized_sample] as i64, 23) as i32;
    ...
    quantize.quantized_sample = quantized_sample as i32;
    quantize.quantized_sample_parity_change = parity_change as i32;
}
