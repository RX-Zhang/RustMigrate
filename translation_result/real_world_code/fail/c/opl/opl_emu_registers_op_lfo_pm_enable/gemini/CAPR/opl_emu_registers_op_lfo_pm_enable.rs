...
fn opl_emu_bitfield(value: u32, start: i32, length: i32) -> u32 {
    let mask = (1u32.wrapping_shl(length.min(32) as u32)).wrapping_sub(1);
    (value.wrapping_shr(start.wrapping_rem(32) as u32)) & mask
}
...
fn opl_emu_registers_byte(regs: &OplEmuRegisters, offset: u32, start: u32, count: u32, extra_offset: u32) -> u32 {
    ...
    let value = *regs.m_regdata.get(index).unwrap_or(&0) as u32;
