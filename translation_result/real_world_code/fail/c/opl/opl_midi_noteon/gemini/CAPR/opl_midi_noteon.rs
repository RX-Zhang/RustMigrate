...
const OPL_EMU_REGISTERS_OPERATORS: usize = (OPL_EMU_REGISTERS_CHANNELS as usize) * 2;
const OP2_2NDVOICE_PRIORITY_PENALTY: usize = 0; // Placeholder for the missing value
