...
fn opl_emu_registers_byte(regs: &mut OplEmuRegisters, offset: u32, start: u32, count: u32, extra_offset: u32) -> u32 {
    ...
    let value = u32::from(regs.m_regdata[index]);
    opl_emu_bitfield(value, start, count)
}

fn opl_emu_registers_word(regs: &mut OplEmuRegisters, offset1: u32, start1: u32, count1: u32, offset2: u32, start2: u32, count2: u32, extra_offset: u32) -> u32 {
...
fn opl_emu_registers_ch_block_freq(regs: &mut OplEmuRegisters, choffs: u32) -> u32 {
