...
struct Opl {
    ...
    opl_gmtimbres: [OplTimbre; 175],
    opl_gmtimbres_voice2: [OplTimbre; 175],
}
...
fn opl_loadbank_op2(opl: &mut Opl, data: &[u8]) -> i32 {
    ...
    for i in 0..175 {
        ...
        opl.opl_gmtimbres_voice2[i].finetune = opl.opl_gmtimbres_voice2[i]
            .finetune
            .wrapping_add(finetune.wrapping_sub(128) as i8);
        buff = &buff[16..];
    }
    0
}

fn opl_load_op2_voice(timbre: &mut OplTimbre, data: &[u8]) {
    // Implementation of opl_load_op2_voice goes here
}
