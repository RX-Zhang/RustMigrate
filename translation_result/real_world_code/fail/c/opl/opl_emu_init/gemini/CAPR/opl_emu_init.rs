...
fn opl_emu_abs_sin_attenuation(input: u32) -> u32 {
    let sin_table: [u16; 245] = [
        ...
        0x008, 0x008, 0x007, 0x007, 0x006, 0x006, 0x005, 0x005, 0x004, 0x004, 0x003, 0x003, 0x002,
        0x002, 0x002, 0x001, 0x001, 0x001, 0x001, 0x000, 0x000, 0x000, 0x000, 0x000
    ];
