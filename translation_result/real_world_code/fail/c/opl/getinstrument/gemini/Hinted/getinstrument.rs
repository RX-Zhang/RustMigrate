...
// Constants
const OPL_EMU_REGISTERS_OPERATORS: usize = 36; // OPL_EMU_REGISTERS_CHANNELS * 2
...
struct OplEmuOpdataCache {
    ...
    multiple: u32,
    eg_sustain: u32,
    eg_rate: [u8; 4], // Adjusted size to match enum states
    eg_shift: u8,
}
...
struct OplEmu {
    ...
    channel: [Box<OplEmuFmChannel>; OPL_EMU_REGISTERS_CHANNELS],
    operator: [Box<OplEmuFmOperator>; OPL_EMU_REGISTERS_OPERATORS],
}
