...
fn opl_emu_bitfield(value: u32, start: i32, length: i32) -> u32 {
    ...
    (shifted & ((1u32.wrapping_shl(length as u32)).wrapping_sub(1))) as u32
}
...
fn opl_emu_registers_ch_output_3(regs: &OplEmuRegisters, choffs: u32) -> u32 {
    if opl_emu_registers_newflag(regs) != 0 {
        opl_emu_registers_byte(regs, 0xc0, 7, 1, choffs.wrapping_rem(OPL_EMU_REGISTERS_REGISTERS as u32))
    } else {
        0
    }
}
